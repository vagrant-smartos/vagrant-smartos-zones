      ...
      module Cap
        class CreateZoneUsers
          def self.create_zone_users(machine)
            ...
            machine.communicate.execute("#{sudo} zlogin #{zone.uuid} mkdir -p /home/vagrant/.ssh")
            machine.communicate.execute("#{sudo} zlogin #{zone.uuid} touch /home/vagrant/.ssh/authorized_keys")
            machine.communicate.execute(%Q{#{sudo} zlogin #{zone.uuid} 'echo "ssh-rsa  vagrant insecure public key" > /home/vagrant/.ssh/authorized_keys'})
            machine.communicate.execute("#{sudo} zlogin #{zone.uuid} chown -R vagrant:other /home/vagrant/.ssh")
