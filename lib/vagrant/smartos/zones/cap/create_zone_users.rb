      ...
      module Cap
        class CreateZoneUsers
          def self.create_zone_users(machine)
            ...
            machine.communicate.execute("pfexec zlogin #{zone.uuid} sed -i -e \\'s@admin@vagrant@\\' /opt/local/etc/sudoers.d/vagrant")
            
            # add vagrant public key to authorized_keys
            machine.communicate.execute("pfexec zlogin #{zone.uuid} echo 'ssh-rsa  vagrant insecure public key' > /home/vagrant/.ssh/authorized_keys")
            machine.communicate.execute("pfexec zlogin #{zone.uuid} chown vagrant:other /home/vagrant/.ssh/authorized_keys")
            machine.communicate.execute("pfexec zlogin #{zone.uuid} chmod 600 /home/vagrant/.ssh/authorized_keys")
          end
        end
      end
    end
